...
const PlayIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={cn("shrink-0 w-6 h-6 md:w-5 md:h-5", className)}>
...
const PrevIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={cn("shrink-0 w-6 h-6 md:w-5 md:h-5", className)}>
...
const ShuffleIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={cn("shrink-0 w-5 h-5 md:w-4 md:h-4", className)}>
...
const RepeatOneIcon = ({ className }: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={cn("shrink-0 w-5 h-5 md:w-4 md:h-4", className)}>
    ...
    <div className="h-[100dvh] max-h-[100dvh] bg-[#0c0a18] relative flex flex-col overflow-hidden text-[#ffffff]">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {[...Array(15)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-[#ff69b4] animate-twinkle"
            style={{
      ...
      <div className="flex-1 w-full max-w-4xl mx-auto px-4 py-6 overflow-y-auto z-10">
        ...
        <div className="bg-[#121224] border-2 sm:border-4 border-[#000000] p-3 sm:p-5 mb-5 shadow-[4px_4px_0_#000000] sm:shadow-[6px_6px_0_#000000] relative rounded-xl text-white">
          ...
          <div className="flex items-center justify-between mb-4 border-b-2 border-[#000000] pb-2 select-none">
            ...
            <div className="flex items-center gap-3">
              {isShuffle && (
                <span className="font-pixel text-[8px] text-[#ff69b4] animate-pulse font-bold">
                  SHUFFLE
                </span>
               )}
               {repeatMode !== 'none' && (
                <span className="font-pixel text-[8px] text-[#2196f3] tracking-wider font-bold">
                  LOOP
                </span>
               )}
            </div>
            ...
            {allSongs.map((song, index) => {
               ...
               return (
                <div
                  ...
                  className={cn(
                    'flex items-center gap-2.5 sm:gap-3 p-2 sm:p-2.5 cursor-pointer transition-all border-2 sm:border-4 rounded-xl relative overflow-hidden',
                    isActive
        ...
        {showUploadModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
            <div className="w-full max-w-md rounded-xl border-2 sm:border-4 border-[#000000] bg-[#121224] p-4 sm:p-6 shadow-[4px_4px_0_#000000] sm:shadow-[6px_6px_0_#000000] text-white max-h-[90vh] overflow-y-auto custom-scrollbar">
              ...
              <form onSubmit={handleUploadSong} className="space-y-4 font-retro text-lg">
                <div>
                  <label className="block text-[#ff69b4] mb-2 font-pixel text-[8px] tracking-wider select-none font-bold">
