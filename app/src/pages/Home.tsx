...
const Home: React.FC = () => {
  ...
  const menuItems: MenuItem[] = useMemo(
    () => [
      ...
      { label: 'LOVE GARDEN', path: '/lovegarden', icon: '🌱', enabled: true },
      { label: 'PILLOW PROMPTS', path: '/pillowprompts', icon: '🌙', enabled: true },
      { label: 'LOVE COUPONS', path: '/lovecoupons', icon: '🎫', enabled: true },
      { label: 'MIXTAPE TRADING', path: '/mixtapes', icon: '📼', enabled: true },
      { label: 'HEARTBEAT SYNC', path: '/heartbeat', icon: '❤️', enabled: true },
      ...
      { label: 'MESSAGE BOTTLE', path: '/messagebottle', icon: '🍾', enabled: true },
      { label: 'HABIT TRACKER', path: '/habittracker', icon: '⭐', enabled: true },
      { label: 'FORTUNE WHEEL', path: '/fortunewheel', icon: '🎡', enabled: true },
      { label: 'LOVE PET', path: '/lovepet', icon: '🐱', enabled: true },
      { label: 'ADVENTURE CHALLENGE', path: '/adventurechallenge', icon: '🛡️', enabled: true },
      { label: 'DREAM VAULT', path: '/dreamvault', icon: '💭', enabled: true },
      { label: 'SPARK PROMPT', path: '/sparkprompt', icon: '⚡', enabled: true },
      { label: 'LOVE LETTER POSTBOX', path: '/lovepostbox', icon: '📮', enabled: true },
