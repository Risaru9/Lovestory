  ...
  return (
    <button
      ...
      className={cn(
        ...
        'font-["Press_Start_2P"] text-[9px] shadow-[2px_2px_0_#000000]',
        active
          ? 'bg-[#ff69b4] text-[#000000] border-[#000000] font-bold'
          : 'bg-[#222230] text-[#a0a0b0] border-[#000000] hover:bg-[#2a2a3e] hover:text-white'
      )}
      aria-pressed={active}
    >
...
const GalleryCard = memo(function GalleryCard({
  ...
  return (
    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden rounded-lg bg-[#0c0a18] border-2 border-[#000000]">
        {!loaded && (
      ...
      <div className="mt-2 px-1 pb-1">
        <p className="font-['VT323'] text-base text-[#ffffff] leading-snug line-clamp-1 group-hover:text-[#ff69b4] transition-colors font-bold">
          {label}
        </p>
        <div className="flex justify-between items-center mt-1 select-none">
          <span className="font-['VT323'] text-xs text-[#a0a0b0] tracking-wider uppercase font-semibold">
            {photo.category}
          </span>
          <Heart className="w-3.5 h-3.5 text-[#a0a0b0]/20 group-hover:text-[#ff69b4] group-hover:scale-110 transition-all duration-200 shrink-0" />
        </div>
      </div>
    </button>
  );
  ...
  return (
    ...
    >
      <button
        ...
        className="absolute left-3 md:left-6 top-1/2 -translate-y-1/2 rounded-xl border-4 border-[#000000] bg-[#121224] p-2 text-white transition hover:bg-[#ff69b4] hover:text-black shadow-[2px_2px_0_#000000] active:scale-95 z-40"
      ...
      <button
        ...
        className="absolute right-3 md:right-6 top-1/2 -translate-y-1/2 rounded-xl border-4 border-[#000000] bg-[#121224] p-2 text-white transition hover:bg-[#ff69b4] hover:text-black shadow-[2px_2px_0_#000000] active:scale-95 z-40"
      ...
      >
        <button
          type="button"
          onClick={onClose}
          className="absolute right-4 top-4 z-10 rounded-full border-2 border-[#000000] bg-[#121224] p-2 text-white transition hover:bg-[#ff69b4] hover:text-black active:scale-95"
          aria-label="Close photo preview"
        >
          <X className="h-5 w-5" />
        </button>

        <div className="absolute left-4 top-4 z-10 rounded-lg border-2 border-[#000000] bg-[#121224] px-3 py-1 font-['Press_Start_2P'] text-[7px] text-white font-bold">
          {currentIndex + 1} / {total}
        </div>

        <div className="grid grid-cols-1 md:grid-cols-[1.2fr_0.8fr]">
          <div className="flex min-h-[300px] items-center justify-center bg-[#0c0a18] p-2">
            <img
              src={photo.src}
              alt={label}
              className="max-h-[70vh] w-full object-contain rounded-lg border-2 border-[#000000]"
            />
          </div>

          <div className="flex flex-col justify-between border-t md:border-t-0 md:border-l border-[#000000] bg-[#121224] p-5 text-[#ffffff]">
            <div>
              ...
              <p className="mt-3 font-['VT323'] text-xl leading-snug text-white font-bold">
                {label}
              </p>
            </div>

            <div className="mt-6 space-y-2 pt-4 border-t border-[#000000]/25">
  ...
  return (
    <div className="h-[100dvh] max-h-[100dvh] bg-[#0c0a18] text-[#ffffff] flex flex-col relative overflow-hidden">
      ...
      <main className="relative z-10 flex-1 max-w-7xl w-full mx-auto px-4 py-6 overflow-y-auto">
        ...
        {/* Banner Section */}
        <section className="mb-6 rounded-xl border-4 border-[#000000] bg-[#121224] p-4 sm:p-5 shadow-[4px_4px_0_#000000] text-[#ffffff]">
          <div className="grid gap-4 md:grid-cols-[1.2fr_0.8fr] md:items-center">
            <div>
              ...
              <h2 className="font-['Press_Start_2P'] text-[10px] sm:text-xs md:text-sm leading-relaxed text-[#ffffff] tracking-wide font-bold">
                Semua kenangan manis kita tersimpan di sini
              </h2>

              <p className="mt-2 font-['VT323'] text-sm sm:text-base leading-normal text-[#a0a0b0]">
            ...
            <div className="grid grid-cols-3 gap-2.5">
              <div className="rounded-xl border-2 border-[#000000] bg-[#1a1a2e]/60 p-2.5 text-center shadow-[2px_2px_0_#000000]">
                <div className="font-['Press_Start_2P'] text-[7px] text-[#a0a0b0]/40 font-bold">TOTAL</div>
                <div className="mt-1 font-['VT323'] text-2xl text-white leading-none font-bold">{allPhotos.length}</div>
              </div>

              <div className="rounded-xl border-2 border-[#000000] bg-[#1a1a2e]/60 p-2.5 text-center shadow-[2px_2px_0_#000000]">
                <div className="font-['Press_Start_2P'] text-[7px] text-[#a0a0b0]/40 font-bold">SHOW</div>
                <div className="mt-1 font-['VT323'] text-2xl text-white leading-none font-bold">{displayedPhotos.length}</div>
              </div>

              <div className="rounded-xl border-2 border-[#000000] bg-[#1a1a2e]/60 p-2.5 text-center shadow-[2px_2px_0_#000000]">
                <div className="font-['Press_Start_2P'] text-[7px] text-[#a0a0b0]/40 font-bold">FILTER</div>
          ...
          <>
            ...
            {visibleCount < filteredPhotos.length && (
              <div className="mt-8 flex justify-center">
                <button
                  ...
                  className="rounded-xl border-2 border-[#000000] bg-[#121224] px-5 py-3.5 font-['Press_Start_2P'] text-[8px] text-white transition hover:bg-[#ff69b4] hover:text-black active:scale-95 duration-100 shadow-[3px_3px_0_#000000] font-bold"
                >
            ...
            {visibleCount >= filteredPhotos.length && (
              <div className="py-10 text-center select-none">
                ...
                <p className="font-['VT323'] text-xl text-[#a0a0b0]/40 tracking-wider">Semua kenangan telah ditampilkan 💕</p>
              </div>
            )}
          </>
        ) : (
          <div className="py-20 text-center select-none">
            <Camera className="mx-auto mb-4 h-12 w-12 text-[#a0a0b0]/20" />
            <p className="font-['Press_Start_2P'] text-[10px] text-[#a0a0b0]/40 font-bold">
              TIDAK ADA FOTO DITEMUKAN
            </p>
            <p className="mt-1 font-['VT323'] text-lg text-[#a0a0b0]/30">
            ...
            <form onSubmit={handleUploadPhoto} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 bg-[#1a1a2a] border-2 border-[#000000] rounded-xl text-[#ffffff] font-['VT323'] text-base file:mr-4 file:py-1 file:px-2.5 file:rounded-md file:border-0 file:text-[8px] file:font-['Press_Start_2P'] file:bg-[#FF69B4] file:text-white file:cursor-pointer hover:file:brightness-110"
                />
              </div>
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="Masukkan deskripsi memori..."
                  value={uploadCaption}
                  onChange={(e) => setUploadCaption(e.target.value)}
                  required
                  className="w-full px-3 py-2 bg-[#1a1a2a] border-2 border-[#000000] rounded-xl text-[#ffffff] focus:outline-none focus:border-[#ff69b4] text-base placeholder-[#a0a0b0]/40"
                />
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 bg-[#1a1a2a] border-2 border-[#000000] rounded-xl text-[#ffffff] focus:outline-none focus:border-[#ff69b4] text-base"
                >
                  <option value="date">KENCAN</option>
                  <option value="travel">JALAN-JALAN</option>
                  <option value="food">MAKANAN</option>
                  <option value="selfie">MOMEN LUCU</option>
                </select>
              </div>

              {uploadError && (
                <div className="bg-red-950/20 border border-red-500/20 rounded-xl px-3 py-2">
                  <p className="font-['VT323'] text-red-400 text-sm font-bold">⚠ {uploadError}</p>
                </div>
              )}
